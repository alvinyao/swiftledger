...
import com.higgschain.trust.evmcontract.datasource.*;
...
public class RepositoryImpl implements com.higgschain.trust.evmcontract.core.Repository, com.higgschain.trust.evmcontract.facade.Repository {
    ...
    @Override
    public synchronized com.higgschain.trust.evmcontract.core.Repository getSnapshotTo(byte[] root) {
        return parent.getSnapshotTo(root);
    }

    @Override
    public synchronized void commit() {
        com.higgschain.trust.evmcontract.core.Repository parentSync = parent == null ? this : parent;
