...
RS_CORE_CONTRACT_ACTION_TYPE_ILLEGAL_ERROR("221", "process contract action type  error", false),
     ...
     */
RS_CORE_CONTRACT_EXECUTE_ERROR("222", "contract process  error", false),
    /**
     * The Rs core tx update failed.
     */
RS_CORE_TX_UPDATE_FAILED("223", "update transaction  failed", false),
    /**
     * The Rs core wait async timeout exception.
     */
RS_CORE_WAIT_ASYNC_TIMEOUT_EXCEPTION("224", "rs core wait async timeout exception", false),
    /**
     * The Rs core tx not exists failed.
     */
RS_CORE_TX_NOT_EXISTS_FAILED("225", "the core transaction not exists failed", false),
    /**
     * The Rs core tx exists failed.
     */
RS_CORE_TX_EXISTS_FAILED("226", "the core transaction already exists failed", false),
    /**
     * The Rs core contract read error.
     */
RS_CORE_CONTRACT_READ_ERROR("227", "contract read  error", false),
    /**
     * The Rs core contract build error.
     */
RS_CORE_CONTRACT_BUILD_ERROR("228", "contract build  error", false),
