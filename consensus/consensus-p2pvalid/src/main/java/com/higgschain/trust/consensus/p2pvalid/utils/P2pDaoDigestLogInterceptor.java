package com.higgschain.trust.consensus.p2pvalid.utils;
...
@Aspect @Repository public class P2pDaoDigestLogInterceptor {
     ...
     */
    @Around("execution(* com.higgschain.trust.consensus.p2pvalid.dao.*Dao.*(..)))") public Object invoke(ProceedingJoinPoint pj)
        throws Throwable {
