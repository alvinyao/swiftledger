package com.higgschain.trust.consensus.core.view;
...
import com.higgschain.trust.consensus.view.ViewCommand;
...
@PrepareForTest({CryptoUtil.class}) public class ClusterViewManagerTest extends PowerMockTestCase {
    ...
    @PrepareForTest({CryptoUtil.class}) @Test public void testChangeViewNull() {
        ...
        BDDMockito.given(mock.verify(Matchers.anyString(), Matchers.anyString(), Matchers.anyString())).willReturn(true);
    ...
    @PrepareForTest({CryptoUtil.class}) @Test public void testChangeViewSignFailed() {
        ...
        Mockito.when(mock.verify(Matchers.anyString(), Matchers.anyString(), Matchers.anyString())).thenReturn(false);
        ...
        Mockito.when(mock.verify(Matchers.anyString(), Matchers.anyString(), Matchers.anyString())).thenReturn(true);
        viewManager.changeView(viewCommand);
        Assert.assertEquals(viewManager.getCurrentView(), view);

        Mockito.when(mock.verify(Matchers.anyString(), Matchers.anyString(), Matchers.anyString())).thenReturn(true).thenReturn(false);
        viewManager.changeView(viewCommand);
        Assert.assertEquals(viewManager.getCurrentView(), view);
    ...
    @PrepareForTest({CryptoUtil.class}) @Test public void testChangeViewUnsupportOpt() {
        ...
        Assert.expectThrows(ConsensusException.class, () -> viewManager.changeView(viewCommand));
    }
    ...
    @Test public void testResetEndHeight() {
        ...
        views.add(view3);
        viewManager.resetViews(views);
        Assert.expectThrows(ConsensusException.class, () -> viewManager.resetEndHeight(20));
        Assert.expectThrows(ConsensusException.class, () -> viewManager.resetEndHeight(22));
        viewManager.resetEndHeight(21);
        ClusterView currentView = viewManager.getCurrentView();
        Assert.assertEquals(currentView.getEndHeight(), 21);

        Assert.expectThrows(ConsensusException.class, () -> viewManager.resetEndHeight(21));
        Assert.expectThrows(ConsensusException.class, () -> viewManager.resetEndHeight(23));
        ...
        Assert.expectThrows(ConsensusException.class, () -> viewManager.resetEndHeight(22));
        Assert.expectThrows(ConsensusException.class, () -> viewManager.resetEndHeight(24));
    }
}